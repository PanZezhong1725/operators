...
def test_cpu(lib, test_cases, tensor_dtypes):
    ...
    for x_shape, w_shape, pads, strides, dilations, x_strides in test_cases:
        for tensor_dtype in tensor_dtypes:
            test(lib, handle, "cpu", x_shape, w_shape, pads, strides, dilations, x_strides, tensor_dtype=tensor_dtype)
...
def test_cuda(lib, test_cases, tensor_dtypes):
    ...
    for x_shape, w_shape, pads, strides, dilations, x_strides in test_cases:
        for tensor_dtype in tensor_dtypes:
            test(lib, handle, "cuda", x_shape, w_shape, pads, strides, dilations, x_strides, tensor_dtype=tensor_dtype)
    destroy_handle(lib, handle)
...
def test_bang(lib, test_cases, tensor_dtypes):
    ...
    for x_shape, w_shape, pads, strides, dilations, x_strides in test_cases:
        for tensor_dtype in tensor_dtypes:
            test(lib, handle, "mlu", x_shape, w_shape, pads, strides, dilations, x_strides, tensor_dtype=tensor_dtype)
    destroy_handle(lib, handle)
